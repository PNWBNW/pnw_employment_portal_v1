      ...
      {showCommand && (
        <div className="space-y-4">
          <div className="rounded-lg border border-border bg-card p-4 space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Preview mode — in production, your wallet will prompt for signature.
            </p>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="flex-1 rounded-md bg-green-600 px-4 py-3 text-sm font-medium text-white hover:bg-green-500"
            >
              Complete Setup
            </button>
          </div>
